...
export default function DropDownButton({buttonName = "Default"}){
    ...
    <div className = "flex md:w-36 md:max-w-7xl justify-between">
        ...
        <div className="hidden md:block">
            ...
            {/*dropdown */}
            <div className = "md:ml-0 ml-6 md:absolute left-0 top-0 md:hidden flex flex-row md:flex-col gap-2 transition-all md:group-hover:flex">
                <p className="opacity-0 hidden md:inline">iama3333333genius</p>

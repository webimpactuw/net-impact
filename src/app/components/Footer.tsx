                                ...
                                <div className="self-stretch h-[185px] flex-col justify-start items-start flex">
                                    {
                                        props.events.map((event) => {
                                            return (<div key={event.shortName} className="self-stretch py-2 justify-start items-start inline-flex">
                                                <div className="grow shrink basis-0 text-slate-900 text-sm font-normal font-['General Sans'] leading-[21px]"><Link href={`/events/${ event.slug.current }`} className="hover:underline active:text-slate-400" >{ event.shortName }</Link></div>
                                            </div>)

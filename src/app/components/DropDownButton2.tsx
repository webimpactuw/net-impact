...
export default function DropDownButton({buttonName = "Default", dropdownItems = []}){
    ...
    <div className = "flex w-36 max-w-7xl justify-between">
        <Link href= "/events" className="flex items-center gap-2 relative group"> {/*removed justify between*/}
            ...
            <div className = "absolute left-0 top-0 hidden flex-col gap-2 transition-all group-hover:flex">
                ...
                <Link href="/events/climatesummit"className="bg-gray-200 hover:bg-gray-300 rounded-md px-2 py-1">
                    Climate Summit
                </Link>
                <div className="border-t border-gray-400 w-156">
                    
                </div>
                <Link href="/events/fallpanel" className="bg-gray-200 hover:bg-gray-300 rounded-md px-2 py-1">
                    Fall Panel
                </Link>
                <div className="border-t border-gray-400 w-156">
                    
                </div>
                <Link href="/events/pastevents" className="bg-gray-200 hover:bg-gray-300 rounded-md px-2 py-1">
                    Past Events
                </Link>
            </div>
        </Link>

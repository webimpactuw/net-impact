...
export default function TeamPage(props: TeamPageProps) {
    return (
        <div className="md:w-[30%] flex flex-col gap-6 text-[#11122D] mb-10">
            <figure className="rounded-3xl overflow-hidden w-[250px] h-[250px] md:w-[200px] md:h-[200px] lg:w-[300px] lg:h-[300px] xl:w-[370px] xl:h-[370px] relative mx-auto bg-slate-300">
            ...
            <div className="flex gap-4">
                { <a href={props.linkedin} className="opacity-100 hover:opacity-70">
                ...
                { <a href={props.twit} className="opacity-100 hover:opacity-70">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                { <a href={props.instagram} className="opacity-100 hover:opacity-70">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">

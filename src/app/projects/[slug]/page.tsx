...
export default async function Committees({ params, }: { params: {slug: string} }) {
  ...
  return project ? (
    <main className="bg-[#EFF5F8] relative">
        ...
        <div className="w-full px-4 sm:px-16 py-20 flex-col justify-start items-center gap-20 inline-flex mt-10">
            <div className="w-full px-[30px] sm:px-[57.78px] py-[50px] sm:py-[101.11px] bg-slate-900 rounded-[40px] flex-col justify-center items-start gap-[72.22px] flex relative">
                    ...
                    <div className="self-stretch flex-col justify-start items-start gap-[14.44px] flex">
                        <div className="self-stretch flex-col justify-start items-start gap-[14.44px] flex">
                            ...
                            <div className="max-w-[649px] self-stretch flex-col justify-start items-start gap-[21.67px] flex">
                                <div className="self-stretch text-white text-[32px] sm:text-[48px] md:text-[56px] font-medium font-['General Sans'] leading-[67.20px]">{ project.name }</div>

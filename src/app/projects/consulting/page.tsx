    ...
    <main className="bg-[#EFF5F8] relative">
        ...
        <div className="w-full px-16 py-20 flex-col justify-start items-center gap-20 inline-flex mt-10">
            {/* <div className="w-full px-[57.78px] py-[101.11px] bg-slate-900 rounded-[40px] flex-col justify-center items-start gap-[72.22px] flex relative">
                ...
                <div className="w-[1400px] flex-col justify-start items-start gap-[21.67px] flex z-20 mb-16 relative">
                    <div className="max-w-[616px] self-stretch flex-col justify-start items-start gap-[14.44px] flex">
        ...
        <div className="w-full h-[257px] relative px-16 py-20 bg-white flex-col justify-start items-center gap-20 inline-flex mt-10">

    ...
    <main className="bg-[#EFF5F8] relative">
        ...
        <div className="max-w-full h-[571px] px-16 py-20 flex-col justify-start items-center gap-20 inline-flex mt-10">
            <div className="w-full h-[411px] px-[57.78px] py-[101.11px] bg-slate-900 rounded-[40px] flex-col justify-center items-start gap-[72.22px] flex relative">
                ...
                <div className="h-[233.11px] flex-col justify-start items-start gap-[21.67px] flex z-20 mb-16 relative">
        ...
        <div className="w-full h-[257px] px-16 py-20 bg-white flex-col justify-start items-center gap-20 inline-flex mt-10">
        {/* <div className="w-[1440px] h-[257px] px-[57.82px] py-[101.19px] bg-white flex-col justify-start items-start gap-[72.28px] inline-flex"> */}
            <div className="self-stretch pt-[3px] justify-start items-start gap-[72.28px] inline-flex z-20">
                ...
                <div className="w-[522px] h-[52px] text-slate-900 text-[20px] font-normal font-['General Sans'] leading-normal">Stay tuned for more information on NIC and how to get involved in the next application cycle!</div>
            </div>
        </div>
    </main>
  );
